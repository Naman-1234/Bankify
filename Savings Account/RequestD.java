 ...
 * @author Naman
 */
public class RequestD extends javax.swing.JFrame {
    /**
     * Creates new form RequestD
     */
    Login1 obj = null;
    public RequestD(Login1 obj) {
        this.obj=obj;
        initComponents();
    }
        ...
        buttonRequest.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(RequestD.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
...
//
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RequestD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
Login1 obj = new Login1();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RequestD(obj).setVisible(true);
            }
        });
    }
